...
RUN apk update && apk add runit curl ca-certificates nginx uwsgi uwsgi-python3 py3-pip py3-yaml py3-lxml py3-requests git
...
RUN pip install git+https://github.com/proycon/clam/
